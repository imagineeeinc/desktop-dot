...
![Empty desktop](./screenshots/screenshot2.2.png)

**Floating Terminal**

![Desktop with floating fastfetch](./screenshots/screenshot2.1.png)

**Floating window**

![Desktop with floating window (image viewer)](./screenshots/screenshot2.12.png)

**Wallpaper selector**

![Wallpaper selector open](./screenshots/screenshot2.3.png)

**Display resolution selector** (allows you to change resolution of other displays when connected)

![Display resolution selector open](./screenshots/screenshot2.4.png)

**Monitor placement**

![Desktop with floating fastfetch](./screenshots/screenshot2.5.png)

**Monitor brightness**

![Desktop with floating fastfetch](./screenshots/screenshot2.6.png)

**A notification**

![Desktop with fastfetch](./screenshots/screenshot2.7.png)

**System menu**

![Desktop with floating fastfetch](./screenshots/screenshot2.8.png)

**Dock**

![Desktop with floating fastfetch](./screenshots/screenshot2.9.png)

**App lancher**

![Desktop with floating fastfetch](./screenshots/screenshot2.10.png)

**Logout menu**

![Desktop with floating fastfetch](./screenshots/screenshot2.11.png)
